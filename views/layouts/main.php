    ...
    <div class="wrapper header__wrapper">
        <div class=" header__headerContent">
            ...
            <ul class="header__list">
                ...
                <li class="header__list-item">
                    <?= Html::a('Приемная комиссия', ['study-request/index'], ['class' => 'header__list-link']) ?>
                </li>
                <li class="header__list-item">
                    <?= Html::a('Отчет', ['student/index'], ['class' => 'header__list-link']) ?>
                </li>
                <li class="header__list-item">
                    <?= Html::a('Отчет Количество', ['student/index', 'mode' => \app\models\StudentSearch::CNT_MODE], ['class' => 'header__list-link']) ?>
                </li>
